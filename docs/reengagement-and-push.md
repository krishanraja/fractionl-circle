...
`supabase/cron_setup.sql`, and `src/pathroom/ReturnSurface.tsx` on 2026-06-29, re-verified
2026-07-05 (cron schedule, 5-21 day window, and delivery_log logic all still match code).*
