  ...
  return (
    <div className="space-y-4">
      ...
      <motion.button
        ...
        className={cn(
          'w-full rounded-2xl px-6 py-10 flex flex-col items-center justify-center gap-3 transition-colors',
      ...
      >
        {step === 'idle' && (
          <>
            ...
            <p className="text-[15px] font-semibold text-foreground">Drop a CSV</p>
            <p className="text-xs text-foreground-muted text-center">HubSpot · Attio · Folk · LinkedIn · anything with a name column</p>
          </>
        )}
        {step === 'parsing' && (
          <>
