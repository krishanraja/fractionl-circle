...
import { TrendingUp, Users, Briefcase, ChevronRight, Sparkles, AlertCircle, Plus, DollarSign } from 'lucide-react';
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-caption text-primary bg-primary/10 rounded-lg px-2.5 py-1"
                  >
