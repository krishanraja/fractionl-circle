...
Entry file for coding agents working in Circle by Fractionl. Codex reads this file natively;
...
This repository's own rules and deeper state: `AGENT_BRIEFING.md`, `docs/DELIVERY_STATE.md`. They outrank the
canon below on anything specific to this repository.

<!-- krish-canon:start release=v2026.08.29.3 sha=386e64099804 rendered=2026-09-07 -->
## Krish canon
...
**This repository's own rules:** `AGENTS.md`, `AGENT_BRIEFING.md`, `docs/DELIVERY_STATE.md`
<!-- krish-canon:end -->
